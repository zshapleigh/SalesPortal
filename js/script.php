...
//HIDE COLUMNS IN PAGINATION
 $(function() {
		...
		$(".selector").datepicker({dateFormat: 'yy-mm-dd', beforeShowDay: nationalDays})   
			
			//missing: memorial day, labor day, 
			natDays = [
			  [<?php echo $dCAL[sls_cal_newyears_m]; ?>, <?php echo $dCAL[sls_cal_newyears_d]; ?>, 'New Years Day'],
			  
			  [<?php echo $dCAL[sls_cal_thanks_m]; ?>, <?php echo $dCAL[sls_cal_thanks_d]; ?>, 'Thanksgiving'],
			  [<?php echo $dCAL[sls_cal_thankseve_m]; ?>, <?php echo $dCAL[sls_cal_thankseve_d]; ?>, 'Black Friday'],
			  [<?php echo $dCAL[sls_cal_christmaseve_m]; ?>, <?php echo $dCAL[sls_cal_christmaseve_d]; ?>, 'Christmas Eve'], 
			  [<?php echo $dCAL[sls_cal_christmas_m]; ?>, <?php echo $dCAL[sls_cal_christmas_d]; ?>, 'Christmas'], 
			  [<?php echo $dCAL[sls_cal_mem_m]; ?>, <?php echo $dCAL[sls_cal_mem_d]; ?>, 'Memorial Day'], 
			  [<?php echo $dCAL[sls_cal_labor_m]; ?>, <?php echo $dCAL[sls_cal_labor_d]; ?>, 'Labor Day'], 
			  [<?php echo $dCAL[sls_cal_ind_m]; ?>, <?php echo $dCAL[sls_cal_ind_d]; ?>, 'Independance Day'], 
			  [<?php echo $dCAL[sls_cal_float_m]; ?>, <?php echo $dCAL[sls_cal_float_d]; ?>, 'Floating Holiday'], 
			  [<?php echo $dCAL[sls_cal_rdfshut1_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut1_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_rdfshut2_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut2_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_rdfshut3_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut3_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_rdfshut4_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut4_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_rdfshut5_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut5_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_rdfshut6_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut6_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_rdfshut7_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut7_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_rdfshut8_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut8_d]; ?>, 'RdF Shutdown'],
			  [<?php echo $dCAL[sls_cal_newyearseve_m]; ?>,<?php echo $dCAL[sls_cal_newyearseve_d]; ?>, 'New Years Eve'],
			  [<?php echo $dCAL[sls_cal_rdfshut9_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut9_d]; ?>, 'RdF Shutdown'],
			  <?php
			  if($dCAL[sls_cal_rdfshut11_m] || $dCAL[sls_cal_rdfshut11_d]){
			  ?>
			  
				[<?php echo $dCAL[sls_cal_rdfshut10_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut10_d]; ?>, 'RdF Shutdown'],
				[<?php echo $dCAL[sls_cal_rdfshut11_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut11_d]; ?>, 'RdF Shutdown']
				
			<?php
			}else if($dCAL[sls_cal_rdfshut12_m] || $dCAL[sls_cal_rdfshut12_d]){
			?>
				[<?php echo $dCAL[sls_cal_rdfshut10_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut10_d]; ?>, 'RdF Shutdown'],
				[<?php echo $dCAL[sls_cal_rdfshut12_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut12_d]; ?>, 'RdF Shutdown']
			<?php
			}else if($dCAL[sls_cal_rdfshut11_m] || $dCAL[sls_cal_rdfshut11_d] || $dCAL[sls_cal_rdfshut12_m] || $dCAL[sls_cal_rdfshut12_d]){
			?>
				[<?php echo $dCAL[sls_cal_rdfshut10_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut10_d]; ?>, 'RdF Shutdown'],
				[<?php echo $dCAL[sls_cal_rdfshut11_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut11_d]; ?>, 'RdF Shutdown'],
				[<?php echo $dCAL[sls_cal_rdfshut12_m]; ?>,<?php echo $dCAL[sls_cal_rdfshut12_d]; ?>, 'RdF Shutdown']
		...
		$(".sel").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays})   
		...
		$("#CQ_DDate").datepicker({ dateFormat: 'yy-mm-dd',gotoCurrent: true,showWeek: true });
		$("#RQ_DDate").datepicker({ dateFormat: 'yy-mm-dd',gotoCurrent: true,showWeek: true });
		$("#prev_delivery").datepicker({ dateFormat: 'yy-mm-dd',gotoCurrent: true,showWeek: true });
		...
		$("#custreq7").click(function () {$("div.custreq7").toggle("slow");});
		...
		$(".newstock").change(function() {
				if($(this).val() == 1){
					...
					$('#ltd, #lte').datepicker({dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays});
		...
		$(".st_q").change(function() {
			if($(this).val() == 'Q'){
				...
				//FU1 = +4 weeks
				//FU2 = +4 weeks
					$(".fu1").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+28');
					$(".fu2").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+56');
				}else 
				if($("#MU").val() == 2){
				//FU1 = +2 weeks
				//FU2 = +2 weeks
					$(".fu1").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+14');
					$(".fu2").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+28');
				}else 
				if($("#MU").val() == 3){
				//FU1 = +2 weeks
				//FU2 = +2 weeks
				...
				//FU1 = +1 weeks
				//FU2 = +1 weeks
					$(".fu1").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+7');
					$(".fu2").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+14');
				}else 
				if($("#MU").val() == 'P'){
				//FU1 = +2 weeks
				//FU2 = +2 weeks
		...
		$("#MU").change(function() {
			...
			if($(this).val() == 1){
				...
				if($("#newsd").val() == 1){
						//alert('MON');
						$("#ltd").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+7');
				}else if($("#newsd").val() == 2){ 
						...
						//alert('SAT');
						$("#ltd").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+6');
				}else if($("#newsd").val() == 7){ 
				
						//alert('SUN');
						$("#ltd").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+5');
				}
		...
		//		$("#ltd").val(datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+3'));	
				if($("#newsd").val() == 1){
						//alert('MON');
						$("#ltd").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+3');
				}else if($("#newsd").val() == 2){ 
						...
						//alert('SAT');
						$("#ltd").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+4');
				}else if($("#newsd").val() == 7){ 
		...
		//		$("#ltd").val(datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+1'));	
				if($("#newsd").val() == 1){
						//alert('MON');
						$("#ltd").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+1');
				}else if($("#newsd").val() == 2){ 
						...
						//alert('SAT');
						$("#ltd").datepicker({ dateFormat: 'yy-mm-dd',beforeShowDay: noWeekendsOrHolidays}).datepicker('setDate', '+2');
				}else if($("#newsd").val() == 7){ 
