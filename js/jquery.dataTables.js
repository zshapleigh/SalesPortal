...
(/** @lends <global> */function($, window, document, undefined) {
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"sSearch": "Search:",
			//<input type="checkbox" name="pidopen" id="pidopen"/>PID-EA&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="poopen" id="poopen"/>PO-Pdate&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="pcdopen"/>PCD-Unit$&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" id="expopen"/>EXP-#Ship<br/>Search:',
